use crate::tui::services::detect_term::{AdaptiveColors, ThemeColors};
use ratatui::{
...
use crate::tui::services::syntax_highlighter;
use crossterm;
...
impl MarkdownStyle {
    ...
    pub fn adaptive() -> Self {
        let is_light = crate::tui::services::detect_term::is_light_mode();
        let is_rgb_supported = crate::tui::services::detect_term::should_use_rgb_colors();
