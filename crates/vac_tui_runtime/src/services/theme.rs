...
impl Theme {
    ...
    pub fn style(&self, key: StyleKey) -> Style {
        match self.preset {
            ...
            ThemePreset::HighContrast => high_contrast::high_contrast(key),
        }
    }
}
...
fn dark(key: StyleKey) -> Style {
    match key {
        ...
        StyleKey::MarkdownH5 => Style::default()
            ...
            .add_modifier(Modifier::BOLD),
        StyleKey::MarkdownH6 => Style::default()
        ...
        StyleKey::MarkdownImportant => Style::default()
            .fg(Color::Rgb(255, 100, 100))
            .add_modifier(Modifier::BOLD),
        ...
        StyleKey::MarkdownTip => Style::default()
            .fg(Color::Rgb(100, 255, 100))
            .add_modifier(Modifier::BOLD),
        StyleKey::MarkdownCaution => Style::default()
            .fg(Color::Rgb(255, 100, 100))
            .add_modifier(Modifier::BOLD),
...
fn light(key: StyleKey) -> Style {
    match key {
        ...
        StyleKey::MarkdownBold => Style::default()
            ...
            .add_modifier(Modifier::BOLD),
        StyleKey::MarkdownItalic => Style::default()
            .fg(Color::Black)
            .add_modifier(Modifier::ITALIC),
        StyleKey::MarkdownStrikethrough => Style::default()
            .fg(Color::Gray)
