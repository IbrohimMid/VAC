...
pub static ACTION_SPECS: &[ActionSpec] = &[
    ...
    ActionSpec {
        ...
        title: "Sandbox Mode",
        description: "Change user sandbox mode",
        scope: ActionContext::Global,
        keybindings: &[],
        slash_aliases: &["/isolation", "/sandbox"],
        palette_visible: true,
        footer_visible: false,
        availability: always_available,
        activity_message: None,
    ...
    ActionSpec {
        ...
        description: "Open the session resume overlay",
        scope: ActionContext::Global,
        keybindings: &["Ctrl+R"],
    ...
    ActionSpec {
        ...
        title: "Sessions",
        description: "Open the sessions workbench",
        scope: ActionContext::Global,
        keybindings: &[],
    ...
    ActionSpec {
        id: ActionId::ForkSession,
        title: "Fork Session",
        description: "Fork the current session (not yet supported)",
        scope: ActionContext::Global,
        keybindings: &[],
        slash_aliases: &["/fork"],
        palette_visible: true,
    ...
    ActionSpec {
        ...
        description: "Open project readiness checklist",
        scope: ActionContext::Global,
        keybindings: &[],
        slash_aliases: &["/init"],
        palette_visible: true,
    ...
    ActionSpec {
        id: ActionId::Thinkback,
        title: "Thinkback",
        description: "Scrub the transcript back to the previous Accepted row",
        scope: ActionContext::Global,
        keybindings: &[],
        slash_aliases: &["/scrub-back"],
        palette_visible: true,
        footer_visible: false,
        availability: always_available,
        activity_message: None,
    ...
    ActionSpec {
        id: ActionId::ThinkbackPlay,
        title: "Thinkback play",
        description: "Replay tool calls from the current thinkback anchor forward",
        scope: ActionContext::Global,
        keybindings: &[],
        slash_aliases: &["/thinkback-play"],
        palette_visible: true,
        footer_visible: false,
        availability: always_available,
        activity_message: None,
